...
update_player = ("UPDATE player SET team_id = 2, first_name = 'Joseph', last_name = 'Gousteau' WHERE first_name = 'Ricky") 

cursor.execute(update_player) 

show_players(cursor, "DISPLAYING PLAYERS AFTER UPDATE") 

delete_player = ("DELETE FROM player WHERE first_name = 'Joseph'") 
